...
export class GruposController {
    ...
    async findAll(
        ...
        try {
            const data: Grupo[] = await this.gruposSrv.findAll({ eliminado, search, id, sort, limit, offset });
            const rowCount: number = await this.gruposSrv.count({ eliminado, search, id});
