...
##############################################################################
#
#   kudejasper start up script for POSIX generated by Gradle.
#
...
#       and KUDEJASPER_OPTS) rely on word-splitting, this is performed explicitly;
...
#   * DEFAULT_JVM_OPTS, JAVA_OPTS, and KUDEJASPER_OPTS environment variables.
...
# Add default JVM options here. You can also use JAVA_OPTS and KUDEJASPER_OPTS to pass JVM options to this script.
DEFAULT_JVM_OPTS=""
...
eval "set -- $(
        printf '%s\n' "$DEFAULT_JVM_OPTS $JAVA_OPTS $KUDEJASPER_OPTS" |
        xargs -n1 |
        sed ' s~[^-[:alnum:]+,./:=@_]~\\&~g; ' |
        tr '\n' ' '
    )" '"$@"'
